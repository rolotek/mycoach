...
```bash
INIT=$(node ./.cursor/get-shit-done/bin/gsd-tools.js init map-codebase)
```
...
```bash
node ./.cursor/get-shit-done/bin/gsd-tools.js commit "docs: map existing codebase" --files .planning/codebase/*.md
```
